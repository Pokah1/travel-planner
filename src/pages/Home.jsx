...
const HomePage = () => {
  ...
  const destinationFeatures = [
    {
      ...
      description: "Explore thousands of destinations with detailed information about attractions and activities"
    },
    {
      icon: Calendar,
      title: "Plan Your Journey",
      description: "Create personalized itineraries with our intuitive planning tools"
    },
    {
      icon: Users,
  ...
  />
            ...
            <button className="h-12 px-8 bg-[#F79C4B] hover:bg-[#F87665] rounded-md">Search Destinations</button>
          </div>
