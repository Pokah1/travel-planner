...
import { Plane, Menu, X, MapPin, Calendar, Heart, User } from "lucide-react";
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-b border-border">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            {/* Logo */}
            <Link to="/" className="flex items-center space-x-2" aria-label="Wanderlust Home">
              <Plane className="h-8 w-8 text-[#03547c]" />
              <span className="text-xl font-bold text-[#03547c]">Wanderlust</span>
            </Link>
...
>
  ...
  <span>{item.label}</span>
              ...
              <Link to="/login">
                <button
                  type="button"
                  className="flex items-center space-x-2 border border-border rounded-md px-3 py-2 hover:bg-[#03547c] hover:text-primary-foreground transition-all"
                >
